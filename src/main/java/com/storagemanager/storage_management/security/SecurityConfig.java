...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, CookieCsrfTokenRepository csrfRepository)
        ...
        // Nada de la aplicación se puede enmarcar: se deja el X-Frame-Options:
        // DENY que pone Spring Security de serie. El visor de documentos no lo
        // necesita: pide el fichero por la API y lo enseña desde la memoria del
        // navegador (blob:), que no pasa por esta cabecera (ver DocumentsPanel).
        http
            .csrf(csrf -> csrf
